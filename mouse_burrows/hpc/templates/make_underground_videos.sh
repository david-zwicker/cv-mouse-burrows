...
#SBATCH -o {JOB_DIRECTORY}/underground_video/log_%A_%a.txt    # File to which stdout and stderr will be written
...
~/Code/cv-mouse-burrows/mouse_burrows/scripts/get_underground_movie.py \
    ...
    --output_file /scratch/underground_video_%a
    --scale_bar \
    --video_id $SLURM_ARRAY_TASK_ID

# copy video to final destination
mv -f /scratch/underground_video_%a* {JOB_DIRECTORY}/underground_video/
